...
dynamic sortJson(
  ...
  // Custom function to sort json based on key and include ascending / descending
  if (sortBy == null) {
    return data;
  }
...
DocumentReference returnJsonKey(String documentID) {
  // take in a document ID and return a document reference of type restaurants
  return FirebaseFirestore.instance.collection('restaurants').doc(documentID);
}
