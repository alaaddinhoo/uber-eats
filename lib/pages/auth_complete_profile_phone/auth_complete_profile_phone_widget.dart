...
import 'auth_complete_profile_phone_model.dart';
export 'auth_complete_profile_phone_model.dart';

class AuthCompleteProfilePhoneWidget extends StatefulWidget {
  const AuthCompleteProfilePhoneWidget({
    super.key,
    required this.email,
  ...
  @override
  State<AuthCompleteProfilePhoneWidget> createState() =>
      _AuthCompleteProfilePhoneWidgetState();
}

class _AuthCompleteProfilePhoneWidgetState
    extends State<AuthCompleteProfilePhoneWidget> {
  late AuthCompleteProfilePhoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthCompleteProfilePhoneModel());
